...
export default function OAuthCallbackPage() {
  ...
  useEffect(() => {
    const handleGoogleOAuthCallback = async () => {
      try {
        ...
        const user = await handleGoogleOAuth(code, state)

        // Log the user in
        login(user)

        setStatus("success")
        setMessage("Welcome! Successfully signed in with Google. Redirecting...")
  ...
  const handleGoogleOAuth = async (code: string, state: string) => {
    ...
    setMessage("Getting Google user information...")
